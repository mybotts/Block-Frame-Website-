        ...
        <main className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center pt-40 pb-24 px-6 md:px-12 text-center pointer-events-none">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white leading-tight">
              Technical Guides <span className="text-gradient">Coming Soon.</span>
            </h1>
            
            <p className="text-xl text-text-secondary font-light leading-relaxed mt-4">
              Our engineering team is finalizing a series of deep-dive tutorials and best practices for deploying autonomous agent systems. The first protocol walkthrough launches within days.
            </p>
