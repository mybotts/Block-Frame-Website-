...
export const services: Service[] = [
  {
    ...
    description:
      "Design, deployment, and management of autonomous AI agents and multi-agent systems. Featuring Hermes-native orchestration, agent workspaces, and revenue-focused automation architectures.",
