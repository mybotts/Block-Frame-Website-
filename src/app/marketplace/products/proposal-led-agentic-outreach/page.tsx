...
const productSchema = {
  ...
  offers: { "@type": "Offer", priceCurrency: "USD", availability: "https://schema.org/InStock", url: "https://www.blockframe.cloud/marketplace/products/proposal-led-agentic-outreach" },
};
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <section className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-sm text-text-secondary">Send us your current stack and goal. We will reply with a practical recommendation and pricing tailored to your requirements.</p>
            </div>
          ...
          <section className="mt-12 glass-card p-6 text-center md:p-10">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-text-secondary">
              Test the complete outreach workflow in your own stack. Full access, no commitment, no credit card. If it works for you, pick a tier that fits. If not, walk away with the blueprint.
            </p>
