...
const docs = [
  {
    ...
    body: "A custom outbound workflow that researches qualified prospects, creates personalized sample assets, publishes private proposal pages, drafts outreach, and routes the campaign through your existing sales stack.",
  },
  {
    title: "Why it matters",
    body: "Most cold outreach asks strangers to trust a promise. This system leads with proof: a prospect-specific sample, a private preview link, and a message that shows the business was actually researched.",
  },
  {
    title: "How we adapt it",
    body: "Your version is built around the tools you already use. That can mean Gmail, Outlook, Hostinger, HubSpot, Airtable, Notion, GoHighLevel, manual CSV review, or a custom approval queue.",
  },
  {
    title: "Safety built in",
    body: "The workflow is designed with daily send limits, duplicate checks, suppression lists, preview URL validation, opt-out handling, and human-reviewable queues before sending.",
  },
];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/images/proposal-led-agentic-outreach-og.png", width: 1200, height: 630, alt: "Proposal-Led Agentic Outreach System by BlockFrame Labs" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Proposal-Led Agentic Outreach System",
    description: "Custom prospecting, proposal pages, email queues, and safety controls for proof-led outreach.",
...
const productSchema = {
  ...
  description: "Custom implementation for prospect research, personalized sample assets, private proposal pages, controlled outreach queues, and safety checks.",
  brand: { "@type": "Brand", name: "BlockFrame Labs" },
  offers: { "@type": "Offer", priceCurrency: "USD", price: "1250", availability: "https://schema.org/InStock", url: "https://www.blockframe.cloud/marketplace/products/proposal-led-agentic-outreach" },
};
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <section className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-sm text-text-secondary">Send us your current stack and goal. We respond as soon as possible with the best next step.</p>
              <p className="mt-3 text-sm text-text-secondary">Pricing starts at the listed tier and scales with lead sources, integrations, approvals, and sending requirements.</p>
            </div>
          ...
          <section className="mt-12 glass-card p-6 text-center md:p-10">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-text-secondary">
              Tell us your niche, website, current mailbox or CRM, and whether you want the blueprint, a build sprint, or monthly management. We will reply as soon as possible with a practical recommendation.
            </p>
