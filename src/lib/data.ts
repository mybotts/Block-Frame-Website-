...
export const marketplaceProducts: MarketplaceProduct[] = [
  ...
  },
  {
    ...
    description:
      "Reusable prompt templates, evaluation rubrics, and workflow patterns for building reliable AI assistants, agents, and internal copilots.",
    category: "AI Templates",
    price: "$99",
    image: "/images/ai-agent-development.png",
  ...
  {
    id: "mp-5",
    title: "AI Agent Training Dashboard",
    description:
      "Dashboard template for tracking agent runs, feedback, evaluations, prompts, and improvement loops across production AI workflows.",
    category: "AI Templates",
    price: "$199",
    image: "/images/ai-agent-development.png",
  ...
  },
  {
    ...
    description:
      "Pre-configured monitoring stack with Grafana dashboards, alerting rules, and AI-powered incident response automation. Works with AWS, GCP, and Azure.",
    category: "Automation",
    price: "$129",
    image: "/images/ai-agent-development.png",
  ...
  {
    id: "mp-7",
    title: "AI Model Fine-Tuning Service",
    description:
      "Dataset preparation, supervised fine-tuning, evaluation, and deployment support for domain-specific LLMs and AI workflows.",
    category: "AI Services",
    price: "Custom",
    image: "/images/ai-agent-development.png",
    gradient: "from-purple-500/30 to-indigo-900/30",
  },
  {
    id: "mp-8",
    title: "Computer Vision API Integration",
    description:
      "Production-ready vision model integrations for image analysis, OCR, moderation, object detection, and multimodal AI applications.",
    category: "AI Services",
    price: "$249",
    image: "/images/ai-agent-development.png",
    gradient: "from-sky-500/30 to-blue-900/30",
  },
  {
    id: "mp-9",
    title: "NLP Processing Pipeline",
    description:
      "Configurable text-processing pipeline for summarization, classification, entity extraction, semantic search, and automated reporting.",
    category: "AI Templates",
    price: "$179",
    image: "/images/ai-agent-development.png",
    gradient: "from-fuchsia-500/30 to-pink-900/30",
  },
];
